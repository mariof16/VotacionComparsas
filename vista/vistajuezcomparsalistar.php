    ...
    <div class="container" id="divcomparsas">
        ...
        <div class="comparsas-list" id="votacioneslistar">
            ...
            foreach($datos as $fila){
                ...
                echo "  <img class='imagenlistarcomparsa' src='img/comparsas/".$fila["foto"].".jpg'>";
                echo "  <div>";
                echo "      <a class=botonvotar href='index.php?controlador=&metodo=&id=".$fila["idComparsa"]."'><img src='img/votar.png'></img></a>";
                echo "  </div>";
                echo "</div>";
            }?>
        </div>
